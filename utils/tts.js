 ...
 */
export async function generateVitsAudio (text, speaker = '随机', language = '中日混合（中文用[ZH][ZH]包裹起来，日文用[JA][JA]包裹起来）', noiseScale = parseInt(Config.noiseScale), noiseScaleW = parseInt(Config.noiseScaleW), lengthScale = parseInt(Config.lengthScale)) {
