import A from"./MessageContentCard-DSh4TXNQ.js";import{bP as K,a9 as M,cu as L,aa as i,ar as p,aq as f,aX as l,d as w,ad as P,ag as _,a$ as U,H as m,aF as X,aK as S,aU as $,aG as q,aV as G,ai as Q,P as b,at as v,bn as J,o as h,b as x,w as z,e as C,u,cv as Y,c as T,W as Z,Q as ee,R as te,X as ie,n as ne,cw as oe}from"./index-BA8U2Ech.js";import{N as re}from"./Spin-wDHDEvn9.js";let k=!1;function le(){if(K&&window.CSS&&!k&&(k=!0,"registerProperty"in window?.CSS))try{CSS.registerProperty({name:"--n-color-start",syntax:"<color>",inherits:!1,initialValue:"#0000"}),CSS.registerProperty({name:"--n-color-end",syntax:"<color>",inherits:!1,initialValue:"#0000"})}catch{}}function ae(e){const{textColor3:n,infoColor:o,errorColor:r,successColor:t,warningColor:a,textColor1:s,textColor2:d,railColor:c,fontWeightStrong:g,fontSize:y}=e;return Object.assign(Object.assign({},L),{contentFontSize:y,titleFontWeight:g,circleBorder:`2px solid ${n}`,circleBorderInfo:`2px solid ${o}`,circleBorderError:`2px solid ${r}`,circleBorderSuccess:`2px solid ${t}`,circleBorderWarning:`2px solid ${a}`,iconColor:n,iconColorInfo:o,iconColorError:r,iconColorSuccess:t,iconColorWarning:a,titleTextColor:s,contentTextColor:d,metaTextColor:n,lineColor:c})}const se={common:M,self:ae},B=1.25,ce=i("timeline",`
 position: relative;
 width: 100%;
 display: flex;
